...
<details>
<summary><strong>L1 - Orientation</strong> (T+12 / 14:07: fewer than two concerns to check)</summary>
...
- At T+24 / 14:19, stop searching. Select the strongest two findings and
...
- Use the session transcript to understand decisions and abandoned attempts. It
  ...
  right contract.
- Judge severity by the likely harm and whether it should stop a merge, not by
  how confident the wording sounds.
...
```text
Finding N
  Location: exact file and changed lines
...
Automated comparison
  ...
  comment I would not forward + why
...
At T+27 / 14:22, open the captured automated review even if your list is short.
At T+33 / 14:28, stop analysis and run the structure check. Do not invent
evidence to make it green; record the gap and reset by T+40 / 14:35.
