"""Deterministic JSON serialization helpers for MittelWerk domain values."""
...
class MittelWerkEncoder(json.JSONEncoder):
    """JSON encoder restricted to explicitly supported MittelWerk value types."""
